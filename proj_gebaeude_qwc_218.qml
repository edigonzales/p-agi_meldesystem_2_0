...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="t_basket">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{1aa80282-815d-4488-87c6-843f5896d0fb}">
      <rule filter="day(age( now(), &quot;nachfuehrung&quot;)) &lt; 365 AND  &quot;art_txt&quot; =  'Gebaeude' " key="{b3b1ce0d-ee88-4e1a-864a-8f1a48ab0602}" symbol="0" label="vor &lt; 1 Jahr erfasst"/>
      <rule filter="day(age( now(), &quot;nachfuehrung&quot;)) &lt; 730 AND day(age(now(), &quot;nachfuehrung&quot;)) >= 365 AND  &quot;art_txt&quot; =  'Gebaeude' " key="{08f36a9e-818d-4306-a0dc-b2ee6817f723}" symbol="1" label="vor 1 - 2 Jahren erfasst"/>
      <rule filter="day(age( now(), &quot;nachfuehrung&quot;)) &lt; 1095 AND day(age(now(), &quot;nachfuehrung&quot;)) >= 730 AND  &quot;art_txt&quot; =  'Gebaeude' " key="{93bdbd09-3b71-4bc2-a894-84c6fe0810b7}" symbol="2" label="vor 2 - 3 Jahren erfasst"/>
      <rule filter="day(age( now(), &quot;nachfuehrung&quot;)) > 1095 AND  &quot;art_txt&quot; =  'Gebaeude'" key="{bfa4e115-7784-4b6b-a5ed-50bab4f654a0}" symbol="3" label="vor mehr als 3 Jahren erfasst"/>
      <rule filter=" &quot;nachfuehrung&quot; IS NULL AND  &quot;art_txt&quot; = 'Gebaeude'" key="{b4981df7-d1d7-451b-ad5a-278ee75e7fcc}" symbol="4" label="kein Datum erfasst"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="210,124,0,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="205,117,0,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="215,45,53,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="215,28,42,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="71,18,21,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="59,1,3,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@4@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="59,1,3,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="'Alter in Tagen: '  ||   day(age( now(), &quot;nachfuehrung&quot;)) "/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="t_basket" expression=""/>
